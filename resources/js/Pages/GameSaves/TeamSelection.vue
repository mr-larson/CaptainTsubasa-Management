                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div v-if="selectedTeam" class="col-span-9 grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-4 flex flex-col gap-3">
                            ...
                            <!-- Radar -->
                            <div class="border border-slate-200 rounded-xl bg-white p-4 flex flex-col items-center">
                            ...
                            <button type="button"
                                ...
                                : 'bg-slate-100 text-slate-400 cursor-not-allowed'"
                                    ...
                                    @click="startWithTeam">
                                {{ startForm.processing ? 'Chargement...' : '▶ Jouer avec ' + selectedTeam.name }}
                            </button>
                        </div>
                            ...
                            <div v-if="roster.length" class="grid grid-cols-2 gap-2 max-h-[620px] overflow-y-auto pr-1">
                                <div v-for="player in roster" :key="player.id"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <!-- Stats clés selon poste -->
                                        <div class="flex gap-2 mt-1">
                                            <div v-for="k in keyStatsFor(player.position).slice(0, 3)" :key="k"
                                                 class="text-center">
