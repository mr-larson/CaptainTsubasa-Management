...
class ContractSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $teamsPlayers = [
            ...
            'Nakahara' => [
                'Goro Kawakami', 'Kohei Hori', 'Takamasa Fujita', 'Jin Toda',
                'Keisuke Haranashi', 'Ken Nagatani', 'Shunta Harukawa', 'Susumu Itao',
                'Goro Kurita', 'Takashi Hatori', 'Shingo Aoi',
                // Remplaçants (3)
        ...
        foreach ($teamsPlayers as $teamName => $playerNames) {
            ...
            foreach ($playerNames as $fullName) {
                ...
                $contracts[] = [
                    'player_id'  => $player->id,
                    'team_id'    => $teamId,
                    'salary'     => $this->calculateWeeklyCost($player->stats ?? [], $player->position?->value),
